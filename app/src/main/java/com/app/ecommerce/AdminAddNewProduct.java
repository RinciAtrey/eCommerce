...
public class AdminAddNewProduct extends AppCompatActivity {
    TextInputEditText et_product_name, et_product_discription, et_product_price;
    Button btn_add_new_product;
    ImageView iv_select_product_image;
    private static final int GalleryPick=1;
    private String Description, Price, Pname, saveCurrentDate, saveCurrentTime;
    private String productRandomKey,downloadImageUrl, CategoryName ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv_select_product_image= findViewById(R.id.iv_select_product_image);
        ...
        iv_select_product_image.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void ValidateProductData() {
        Description = et_product_discription.getText().toString();
        Price = et_product_price.getText().toString();
        Pname = et_product_name.getText().toString();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        if (requestCode==GalleryPick  &&  resultCode==RESULT_OK  &&  data!=null)
        {
            ...
            iv_select_product_image.setImageURI(ImageUri);
        }
    }
